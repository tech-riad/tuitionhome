...
class ConfoirmJobExport implements FromCollection, WithHeadings, WithStyles
{
    /**
    ...
    */
    public function collection()
    {
        return JobApplication::select(
                'id', 'tutor_id', 'job_offer_id', 'confirm_date', 'charge','tuition_salary','tutoring_start_date',
                'confirm_about', 'current_stage','created_at'
            )
    ...
    {
        return [
            'ID', 'Tutor ID','TUTOR NAME','TUTOR PHONE','Job Offer ID', 'CONFIRM DATE','TUITION SALARY', 'CHARGE','TUITION START DATE','CONFIRM ABOUT','CURRENT STAGE','CREATED AT'
