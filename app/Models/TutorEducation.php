...
class TutorEducation extends Model
{
    ...
    protected $fillable = ['tutor_id', 'degree_name', 'curriculum_id','institute_id','department_id','university_type','passing_year','result','result_type','cgpa_scale','certificate_image'];
