...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('backend/stylesheet.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('backend/loading.css')}}">
	<link href='http://fonts.googleapis.com/css?family=Signika' rel='stylesheet' type='text/css'>
	<!-- <link href='http://fonts.googleapis.com/css?family=Nunito' rel='stylesheet' type='text/css'> -->
	<link rel="stylesheet/less" href="{{asset('backend/cake.less')}}">
...
<body>
	...
	<audio class="song" controls loop>
        <source src="{{asset('backend/hbd.mp3')}}"></source>
	...
	<div class="balloons text-center" id="b5">
    	<h2 style="color:#8377E4;">P</h2>
    </div>
    <div class="balloons text-center" id="b6">
    	<h2 style="color:#99C96A;">O</h2>
    </div>
    <div class="balloons text-center" id="b7">
    	<h2 style="color:#20CFB4;">N</h2>
    </div>

    <img src="{{asset('backend/Balloon-Border.png')}}" width="100%" class="balloon-border">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12 text-center">
				<img src="{{asset('backend/banner.png')}}" class="bannar">
			</div>
		</div>
		...
		<div class="navbar navbar-fixed-bottom">
			<div class="row">
				<div class="col-md-6 text-center col-md-offset-3">
					...
					<!-- <a href="#" class="btn btn-primary" id="cake_cut">Let's Be Happy</a> -->
				</div>
			</div>
			<!-- <div class="col-md-2">
			</div>
...
<script src="{{asset('backend/effect.js')}}"></script>
</html>
