        ...
        <div class="col-md-12 ms-sm-auto col-lg-12" style="margin-top: 62px">
            ...
            <div class="d-flex flex-wrap mb-4 mb-md-0 justify-content-between align-items-center">
                <div class="d-flex gap-4 flex-column flex-md-row px-3 py-4">
                    <a class="text-decoration-none text-gray-800 active-border" href="{{route('admin.all.notice')}}">All Notice
                        Dashboard</a>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="group" role="tabpanel" aria-labelledby="home-group">
                        <div class="py-4">
                            ...
                            <form id="smsForm" action="{{route('admin.all.notice.tutor.send')}}" method="POST">
                                @csrf
                                ...
                                <div class="mb-4">
                                    <label class="mb-2" style="font-weight: 500" required>SMS Title</label>
                                    <input name="title" class="form-control rounded-2 shadow-none py-3" placeholder="Maximum 30 Characters">
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="">
                                    <div id="char">0/250</div>
                                    <div>Remaining: <span id="rem">250</span></div>
                    ...
                    <div class="tab-pane fade" id="unit" role="tabpanel" aria-labelledby="unit-tab">
                        <div class="py-4">
                            <form id="smsFormUnit" action="{{route('admin.all.notice.unit.send')}}" method="POST">
                                @csrf
                                <input type="hidden" name="send_now" value="{{ date('Y-m-d') }}" id="sendNowUnit">
                                <div class="mb-4">
                                    <label class="mb-2" style="font-weight: 500">Select Users</label>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="numbers" id="numbers" placeholder="Add numbers" class="form-control rounded-2 shadow-none" style="min-height: 100px"></textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="mb-2" style="font-weight: 500" required>SMS Title</label>
                                    <input name="title" class="form-control rounded-2 shadow-none py-3" placeholder="Maximum 30 Characters">
                                ...
                                <div class="mb-4">
                                    <label for="description" class="form-label required">Unit SMS Body</label>
                                    <textarea
                                        name="description"
                                        class="form-control"
                                        placeholder="SMS Body"
                                ...
                                <div id="char-left-message-unit" class="text-danger"></div>

                                <div class="">
                                    <div id="char_unit">0/250</div>
                                    <div>Remaining: <span id="rem_unit">250</span></div>
                                    <div>Message: <span id="msg_unit">0</span></div>
                                </div>
                                ...
                                <div class="d-flex justify-content-end gap-4">
                                    <button type="submit" class="btn btn-primary" id="sendNowBtnUnit">Send Now</button>
                                </div>
                            </form>
            ...
            <div class="ps-3" style="padding-right: 13px">
                <div
                    ...
                    <div class="d-flex justify-content-between gap-3 mb-3 mb-xl-0">
                        ...
                        {{-- <a href="{{route('admin.all.notice.send')}}" class="btn btn-danger">Test</a> --}}
                    </div>
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td class="">
                                            <div class="d-flex gap-4">
                                                <a href="javascript:void(0);" class="btn btn-pink rounded-3 deleteNotice" data-id="{{ $item->id }}">
                                                    Delete
                                                </a>
                                                <a href="javascript:void(0);"
                                                        class="btn btn-success rounded-3 openEditModal"
                                                        data-id="{{ $item->id }}">
                                                        Edit
                                                </a>
                                            </div>
            ...
            <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <form id="editForm" method="POST" action="{{ route('admin.marketting.plan.update') }}">
                            @csrf
                            ...
                            <div class="modal-body">
                                <div class="mb-4">
                                    ...
                                    <input id="edit-title" name="title" class="form-control" placeholder="Maximum 30 Characters">
                                    <span class="text-danger" id="title_error"></span>
                                </div>
                                <div class="mb-4">
                                    <label for="description" class="form-label">Unit SMS Body</label>
                                    <textarea id="edit_description" name="description" class="form-control" style="height: 195px;"></textarea>
                                    <span class="text-danger" id="description_error"></span>
                                </div>

                                <div id="edit-char-left-message-unit" class="text-danger mt-2 fw-bold"></div>

                                <div class="mt-2">
                                    <div id="edit_char_unit">0/250</div>
                                    <div>Remaining: <span id="edit_rem_unit">250</span></div>
                                    <div>Message: <span id="edit_msg_unit">0</span></div>
                                </div>
                            </div>
