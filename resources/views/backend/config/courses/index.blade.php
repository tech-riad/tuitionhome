...
@section('content')
    ...
    <div class="modal fade" id="CourseImport" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('admin.config.course.import.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">

                        <div class="form-group">
                            <label for="">Course Import CSV FIle</label>
                            <input type="file" class="form-control" name="import_course" required>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-primary">Import Course</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            <form action="{{route('coursesSearch')}}" method="post">
                @csrf
            ...
            <div class="card-body p-0">
                @include('backend.config.courses.table')
