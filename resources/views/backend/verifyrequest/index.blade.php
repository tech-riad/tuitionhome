    ...
    <div class="row">
        <div class="col-md-2">
            <div class="report-card card" style="text-align:center">
                <h2>{{App\Models\VerificationRequest::all()->count()}}</h2>
                <span>Total Request</span>
            </div>
        </div>
        <div class="col-md-2">
            <div class="report-card card" style="text-align:center">
                <h2>{{ App\Models\VerificationRequest::whereDate('created_at', today())->count() }}
                </h2>
        ...
        <div class="col-md-2">
            <div class="report-card card" style="text-align:center">
                <h2>{{ App\Models\VerificationRequest::whereDate('action_at', today())->count() }}
                </h2>
        ...
        <div class="col-md-2">
            <div class="report-card card" style="text-align:center">
                <h2>{{ App\Models\VerificationRequest::where('request_status', 'accepted')->count() }}</h2>
                <span>Total Accepted Request</span>
            </div>
        </div>
        <div class="col-md-2">
            <div class="report-card card" style="text-align:center">
                <h2>{{ App\Models\VerificationRequest::where('request_status', 'rejected')->count() }}</h2>
                <span>Total Decline Request</span>
            </div>
        </div>
        <div class="col-md-2">
            <div class="report-card card" style="text-align:center">
                <h2>{{ App\Models\VerificationRequest::where('request_status', 'waiting')->count() }}</h2>
...
<section id="content_section" class="content">
    <div class="card box-default">
        <div class="card-header with-border">
            <h1 class="card-title"><i class="fa fa-eye"></i> All Verification Requests</h1>
        </div>
        <br>
        <div class="d-flex justify-content-between flex-column flex-lg-row gap-2 gap-lg-0">
            <div class="ml-3 d-flex justify-content-between gap-3">
                ...
                <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#addVerifyRequest">
                    Add Request
                </button>

            </div>
            <div class="d-flex gap-3 mr-3">
                <form action="{{ route('admin.verify.request.search') }}" method="post">
                    @csrf
                ...
                <form id="premiumMembership" action="{{ route('admin.verify.request') }}" method="GET">
        ...
        <div class="card-body">
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a target="_blank"
                                href="{{route('admin.tutor.tutorshow',$item->tutor_id)}}">{{$item->tutor_id}}</a>
                        </td>
                        <td>{{$item->name}}
                            ...
                            <div class="modal fade" id="grantModal_{{$item->id}}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{route('admin.grant.verification.request')}}" method="post">
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input required name="transction_id" type="text"
                                                        class="form-control rounded-3 shadow-none" id="transction_id" value="{{$item->transction_id}}"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input required name="taka" type="text"
                                                        ...
                                                        placeholder="" value="{{$item->taka}}" style="padding: 14px 18px" />
                            ...
                            <div class="modal fade" id="declineModal_{{$item->id}}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{route('admin.decline.verify.application')}}" method="post">
                                            @csrf
                                            <div class="modal-body">
                            ...
                            <div class="modal fade" id="noteModal_{{$item->id}}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{route('admin.verify.request.note')}}" method="post">
                                            @csrf
                                            <div class="modal-body">
                            ...
                            <div class="modal fade" id="waitingModal_{{$item->id}}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{route('admin.waiting.verify.application')}}" method="post">
                                            @csrf
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    <label for="expected_waiting_date" class="form-label">Expected Date and Time</label> <br>
                                                    <input type="datetime-local" name="expected_waiting_date" value="{{ old('expected_waiting_date') ? old('expected_waiting_date') : $item->expected_waiting_date }}">
                                                </div>
            ...
            <div id="paginationLinks">
                {{ $requests->appends(['pagination_limit' => $paginationLimit])->links() }}
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.filter.verify.application') }}" method="post">
                @csrf
                <div class="modal-body">
                    <div class="pb-3">
                    ...
                    <div class="pb-3">
                        ...
                        <select name="user_id" class="form-select rounded-3 shadow-none select2" aria-label="Default select" id="user_id">
                    ...
                    <div class="pb-3">
                        ...
                        <select name="status" class="form-select rounded-3 shadow-none select2" aria-label="Default select" id="user_id">
                    ...
                    <div class="pb-3">
                        ...
                        <select name="channel_name" class="form-select rounded-3 shadow-none select2" aria-label="Default select" id="user_id">
...
<div class="modal fade font-pop" id="addVerifyRequest" tabindex="-1" aria-labelledby="addVerifyRequestLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-slide-right" style="max-width: 1100px">
        <div class="modal-content pb-4 pt-3">
            <div class="modal-header" style="padding-left: 40px; padding-right: 40px">
                <h4 class="modal-title" id="exampleModalLabel">Verify Request Add</h4>

                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('admin.add.verify.application') }}" method="POST">
                @csrf
