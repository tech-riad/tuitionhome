            ...
            <div class="col-md-12 ms-sm-auto col-lg-12" style="margin-top: 62px">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex gap-4 flex-column flex-md-row px-3 py-4">
                        <a class="text-decoration-none text-gray-800 active-border" href="{{route('admin.request.tutor')}}">Tutor Requests</a>
                        <a class="text-decoration-none text-gray-800 text-nowrap" href="{{route('admin.cat.request')}}">Category
                            Requests</a>
                    </div>
                </div>
                <!-- mini nav ends here -->
                ...
                <div class="ps-3" style="padding-right: 13px">
                    <div
                        ...
                        <div class="d-flex flex-wrap flex-md-nowrap gap-3">
                            <form action="{{route('admin.tutor.request.search')}}" method="post">
                                @csrf
                    ...
                    <div class="bg-white shadow-lg rounded-3 p-2 my-4">
                        <div class="bg-white pb-4 mb-b">
                                ...
                                <table class="table table-hover bg-white shadow-none" style="border-collapse: collapse">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            {{-- <td class="text-nowrap">{{$item->tutor->name ?? ''}}</td> --}}
                                            <td class="text-info">{{$item->tutor_id ?? ''}}</td>
                                                ...
                                                <div class="d-flex gap-2">
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" style="border: 1px solid #d7dfe9">
                                                            <li>
                                                                <a class="dropdown-item" href="{{route('admin.parent.tutor.lead.job.post',$item->id)}}">Post Job</a>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item" data-bs-toggle="modal"
                                                                    data-bs-target="#parentsNoteModal_{{$item->id}}" href="#">Parents
                                                                    Note</a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item" data-bs-toggle="modal"
                            ...
                            <div class="d-flex justify-content-center align-items-center gap-2 mt-3">
                                ...
                                {{ $tutorRequest->appends(request()->except('page'))->links() }}
                            ...
                            <div class="modal-content pb-4 pt-3">
                                ...
                                <div class="modal-footer d-flex justify-content-end align-items-center"
                                    ...
                                    <div class="pe-2 d-flex gap-3">
                                        <form action="{{route('admin.tutor.request.filter')}}" method="post">
                                            @csrf
                                            <div>
                                                ...
                                                <input type="hidden" id="tutor_filter" name="tutor_filter" value="">
