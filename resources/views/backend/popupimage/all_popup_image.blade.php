...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12 ms-sm-auto col-lg-12" style="margin-top: 62px">
            ...
            <div class="d-flex flex-wrap mb-4 mb-md-0 justify-content-between align-items-center">
                <div class="d-flex gap-4 flex-column flex-md-row px-3 py-4">
                    <a class="text-decoration-none text-gray-800 " href="{{route('admin.all.notice')}}">All Notice
                        Dashboard</a>
                    <a class="text-decoration-none text-gray-800 text-nowrap active-border" href="{{route('admin.all.popupimage')}}">All Popup Images</a>
            ...
            <div class="mx-3 bg-white shadow-lg p-4 rounded-3 mb-4 px-lg-5 py-lg-4">
                                            ...
                                            <div class="pb-3">
                                                ...
                                                <div>
                                                    <input name="datef" type="date"
                                                        class="form-control shadow rounded-2" id="datef" />
                                                </div>
                                            </div>
                                            <div class="pb-3">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="subject_id"
                                                    class="select2 form-select rounded-3 shadow-none" id="subject_id"
                                                    style="padding: 14px 10px; height: auto;">
                                                    <option value=''>Select Category</option>
                                    ...
                                    <div class="d-flex justify-content-start">
                                        <div>
                                            ...
                                            <div class="pb-3">
                                                ...
                                                <select name="tutor_university_id" class="shadow rounded-2 form-select"
                                                    style="width: 215px" id="tutor_university_id"
                                            ...
                                            <div class="pb-3">
                                                ...
                                                <select name="department_id" style="width: 215px"
                ...
                <!-- Parent Filter Model Start here -->
                <div class="modal fade font-pop" id="filterParentsModal" tabindex="-1"
                                ...
                                <form id="parentFilterForm">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input name="datefp" type="date" class="form-control shadow rounded-2"
                                                id="datefp" />

                                            <label for="datetp" class="form-label mt-3">Date To</label>
                                            <input name="datetp" type="date" class="form-control shadow rounded-2"
                                                id="datetp" />
                ...
                <div class="tab-content mt-4 mb-4" id="myTabContent">
                    <div class="tab-pane fade show active" id="group" role="tabpanel" aria-labelledby="home-group">
                        <form id="smsForm" action="{{ route('admin.all.popup.tutor.send') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                    ...
                    <div class="tab-pane fade" id="unit" role="tabpanel" aria-labelledby="unit-tab">
                        <form id="unitPopupForm" action="{{ route('admin.all.popup.unit.send') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-4">
                                <label for="title" class="mb-2" style="font-weight: 500">Image Title</label>
                                <input name="title" id="title" class="form-control rounded-2 shadow-none py-3" placeholder="Maximum 30 Character" />
                              </div>
                            <div class="mb-4">
                                <label for="image" class="form-label">Image</label>
                                <input name="image" type="file" class="form-control" id="image" required>
                                <div id="image_error" class="text-danger"></div>
                                <div class="mt-3" id="image_preview"></div> <!-- Image preview area -->
                            </div>
                            ...
                            <script>
                                document.getElementById('image').addEventListener('change', function (e) {
                                    ...
                                    if (file && file.type.startsWith('image/')) {
                                        ...
                                        preview.innerHTML = '<p class="text-danger">Invalid file type. Please select an image.</p>';
                                    }
                                });
                            </script>
                            <div class="d-flex justify-content-end gap-4">
    ...
    @include('backend.popupimage.js.all_popup_imagejs');
    @endpush