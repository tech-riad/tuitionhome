...
<main class="">
    <div class="col-md-9 ms-sm-auto col-lg-12" style="">
        ...
        <div class="d-flex gap-4 flex-column flex-md-row p-3 mb-2">
            ...
            <a class="text-decoration-none text-gray-800 active-border" href="{{route('admin.boost.featured')}}">Boost Tutor</a>
        ...
        <div class="ps-3" style="padding-right: 13px">
            ...
            <div class="d-flex justify-content-between flex-column flex-lg-row gap-2 gap-lg-0">
                ...
                <div class="d-flex justify-content-between gap-3">
                    ...
                    @endif
                    <form action="{{ route('admin.boost.tutor.job') }}" method="post">
                        @csrf
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body pt-4 pb-4 px-5">
                                            <div class="row row-cols-2 mt-3 border-bottom border-2 mb-4">
                                                ...
                                                @if ($tutor->boost_package == 1)
                                                    <p class="">1 Months</p>
                                                @elseif ($tutor->boost_package == 3)
                                                    <p class="">3 Months</p>
                                                @elseif ($tutor->boost_package == 6)
                                                    <p class="">6 Months</p>
                                                @elseif ($tutor->boost_package == 12)
                                                    <p class="">12 Months</p>
                                                @endif
                                            </div>

                                            <div class="row row-cols-2">
                                                <p class="fw-semibold">Boost Date</p>
                                                <p class="">{{$tutor->boost_date ?? ''}}</p>

                                            </div>
                                            <div class="row row-cols-2">
                                                <p class="fw-semibold">Job Confirm</p>

                                                <p class="">{{ $jobConfirm }}</p>
                                            </div>
                                            <div class="row row-cols-2">
                                                <p class="fw-semibold">Boost Expire </p>
                                                <p class="">{{ $tutor->boost_expire ?? '' }}</p>
                                            </div>
