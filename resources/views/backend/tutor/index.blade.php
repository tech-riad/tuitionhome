...
<main class="">
    <div class="col-md-9 ms-sm-auto col-lg-12" style="">
        ...
        <div class="d-flex gap-4 flex-column flex-md-row p-3 mb-2">
            ...
            {{-- <a class="text-decoration-none text-gray-800" href="{{route('admin.tutor.featured')}}">Featured
            Tutor</a> --}}
            ...
            <a class="text-decoration-none text-gray-800" href="{{route('admin.tutor.member.count')}}">Membership
                Count</a>
    ...
    <div class="ps-3" style="padding-right: 13px">
        ...
        <div class="bg-white shadow-lg rounded-3 p-2 my-4">
            <table id="example1"
                class="table table-responsive table-hover bg-white shadow-none"
                    ...
                    <tr class="" style="vertical-align: middle">
                        ...
                        <style>
                            .star-container {
                                ...
                                height: 24px;
                                overflow: hidden;
                                /* Ensures only the needed part is shown */
                            }
                        ...
                        <td class="text-info">
                            <a href="{{ route('admin.tutor.tutorshow', ['tutor' => $tutor->id]) }}"
                                ...
                                style="background-color: #e6eef7">{{ $tutor->unique_id }}</a>

                            <div class="rating d-flex">
                                @for ($i = 1; $i <= 5; $i++) @php $fillPercentage=max(0, min(100, ($tutor->
                                    average_rating - ($i - 1)) * 100));
                                    @endphp
                                    <div class="star-container">
                                        <i class="far fa-star text-secondary"></i> {{-- Empty Star --}}
                                        <div class="star-overlay" style="width: {{ $fillPercentage }}%;">
                        ...
                        <td class="text-nowrap">{!! nl2br(e(Str::limit($tutor->name ?? 'NA', 7))) !!}
                            ...
                            <img height="30px"
                                src="https://tuitionterminal.com.bd/assets/premium-regular-9c7ea3fd.svg" alt="">
                            @endif
                            ...
                            <img height="30px"
                                src="https://tuitionterminal.com.bd/assets/premium-advance-4b8e47d2.svg" alt="">
                            @endif
                            ...
                            <img height="30px"
                                src="https://tuitionterminal.com.bd/assets/featured-icon-0c358655.svg" alt="">
                        ...
                        <td scope="col" class="text-nowrap">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="statusForm_{{$tutor->id}}">
                                                ...
                                                \App\Models\TutorStatusNote::where('tutor_id', $tutor->id)
                                                ->orderBy('id', 'desc')
                                                ->limit(10)
                                                ->get();
                                                @endphp
                            ...
                            <button
                                class="btn @php echo $tutor->is_active == 1 ? 'btn-primary' : 'btn-danger'; @endphp py-1"
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    ...
                                                    <input required type="text" class="form-control"
                                                        id="changed_noteUndo_{{$tutor->id}}" name="changed_note"
                                ...
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content text-center">
                                        <form id="btnalert{{ $tutor->id }}"
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <label for="changed_note_{{$tutor->id}}" class="form-label">Make
                                                        Alert note here:</label>
                                                    <input required type="text" class="form-control"
                                                        id="changed_note_{{$tutor->id}}" name="changed_note"
                                                        placeholder="Enter your note here...">
                                                </div>
                                            </div>
                                            <div class="modal-footer text-center">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="subject_id[]" class="select2 form-select rounded-3 shadow-none"
                                        multiple id="subject_id" style="padding: 14px 10px; height: auto;">
...
$(document).ready(function () {
    ...
    /* =========================================================
       ...
       IMPORTANT:
       We NEVER get tutor ID from modal.

       We ALWAYS get tutor ID from the button clicked.
    ========================================================= */
    ...
    $(document).on('click', '.btn-note', function (e) {
        ...
        /*
        ---------------------------------------------------------
        Get clicked tutor ID
        ---------------------------------------------------------
        */

        const tutorId = $(this).attr('data-tutor-id');
        ...
        */
        ...
        $('#current_note_tutor_id').val(tutorId);

        $('#note_tutor_id').val(tutorId);


        console.log(
            'Current Modal Tutor ID:',
            $('#current_note_tutor_id').val()
        );
        ...
        */
        ...
        /*
        ---------------------------------------------------------
        Load notes for THIS tutor only
        ---------------------------------------------------------
        */

        getTutorNotes(tutorId);
    ...
    function getTutorNotes(tutorId) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                */
                ...
                Make sure response belongs to requested tutor.
                -------------------------------------------------
                */

                if (
                    response.request_id &&
                    String(response.request_id) !== String(tutorId)
                ) {
    ...
    $(document).on(
        ...
        function (e) {
            ...
            -----------------------------------------------------
            IMPORTANT:
            Current modal tutor ID MUST equal form tutor ID
            -----------------------------------------------------
            */
            ...
            if (
                ...
                console.error(
                    'Tutor ID mismatch before save!'
                );

                alert(
                    'Tutor ID mismatch. Please reopen the Note window.'
                );
                ...
                success: function (response) {
                    ...
                    if (
                        ...
                        */
                        ...
                        /*
                        -----------------------------------------
                        Reload ONLY current tutor's notes
                        -----------------------------------------
                        */
