                        ...
                        <tr class="" style="vertical-align: middle">
                            ...
                            <style>
                                .star-container {
                                    ...
                                    height: 24px;
                                    overflow: hidden; /* Ensures only the needed part is shown */
                                }
                                ...
                                .star-overlay i {
                                    ...
                                    left: 0;
                                    top: 0;
                                    clip-path: inset(0 calc(100% - var(--fill)) 0 0); /* Clips the star properly */
                                }
                            ...
                            <td class="text-info">
                                ...
                                <div class="rating d-flex">
                                    @for ($i = 1; $i <= 5; $i++)
                                        @php
                                            $fillPercentage = max(0, min(100, ($tutor->average_rating - ($i - 1)) * 100));
                                        @endphp
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="statusForm_{{$tutor->id}}">
                                                    ...
                                                    @php
                                                        $tutor_status_changed_notes = \App\Models\TutorStatusNote::where('tutor_id', $tutor->id)
                                                            ->orderBy('id', 'desc')
                                                            ->limit(10)
                                                            ->get();
                                                    @endphp
                            ...
                            <td>
                                <div class="switch-toggle">
                                    <div class="button-check" id="button-check" data-id="{{$tutor->id}}"
                                        ...
                                        <input type="checkbox" class="checkbox" {{ $tutor->is_sms == 1 ? 'checked' : '' }} />
