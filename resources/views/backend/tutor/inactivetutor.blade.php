...
<main class="">
    <div class="col-md-9 ms-sm-auto col-lg-12" style="">
        ...
        @php
        $dhaka = App\Models\TutorPersonalInfo::where('city_id',1)->count();
        $chittagong = App\Models\TutorPersonalInfo::where('city_id',3)->count();
        $sylhet = App\Models\TutorPersonalInfo::where('city_id',7)->count();
        $Rajshahi = App\Models\TutorPersonalInfo::where('city_id',11)->count();
        $Barishal = App\Models\TutorPersonalInfo::where('city_id',12)->count();
        $Khulna = App\Models\TutorPersonalInfo::where('city_id',13)->count();
        $Rangpur = App\Models\TutorPersonalInfo::where('city_id',10)->count();
        $Mymensingh = App\Models\TutorPersonalInfo::where('city_id',9)->count();
        $Gazipur = App\Models\TutorPersonalInfo::where('city_id',4)->count();
        $Manikganj = App\Models\TutorPersonalInfo::where('city_id',32)->count();
        $Narayanganj = App\Models\TutorPersonalInfo::where('city_id',5)->count();
        $Narsingdi = App\Models\TutorPersonalInfo::where('city_id',18)->count();
        $Tangail = App\Models\TutorPersonalInfo::where('city_id',24)->count();
        $Bogra = App\Models\TutorPersonalInfo::where('city_id',14)->count();
        $Pabna = App\Models\TutorPersonalInfo::where('city_id',26)->count();
        $Dinajpur = App\Models\TutorPersonalInfo::where('city_id',25)->count();
        $Thakurgaon = App\Models\TutorPersonalInfo::where('city_id',46)->count();
        $Patuakhali = App\Models\TutorPersonalInfo::where('city_id',68)->count();
        $Brahmanbaria = App\Models\TutorPersonalInfo::where('city_id',20)->count();
        $Chandpur = App\Models\TutorPersonalInfo::where('city_id',40)->count();
        $Cumilla = App\Models\TutorPersonalInfo::where('city_id',8)->count();
        $Coxbazar = App\Models\TutorPersonalInfo::where('city_id',30)->count();
        $Noakhali = App\Models\TutorPersonalInfo::where('city_id',19)->count();
        $Feni = App\Models\TutorPersonalInfo::where('city_id',16)->count();
        $Jashore = App\Models\TutorPersonalInfo::where('city_id',17)->count();
        $Savar = App\Models\TutorPersonalInfo::where('city_id',6)->count();
        @endphp
                    ...
                    <tbody>
                        ...
                        <tr class="" style="vertical-align: middle">
                            ...
                            <td scope="col" class="text-nowrap">
                                <!-- Status Modal -->
                                <div class="modal  fade" id="statusModal_{{$tutor->id}}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-xl">
                                        <div class="modal-content">
                                                ...
                                                <form id="statusForm_{{$tutor->id}}">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="status" class="form-select"
                                                            ...
                                                            <option value="1" @if ($tutor->is_active == 0) selected
                                                                @endif>Active</option>
                                                            <option value="0" @if ($tutor->is_active == 1) selected
                                                                @endif>Inactive</option>
                                                        </select>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="changed_note" class="form-label">Reason
                                                            Changed</label>
                                                        <textarea name="changed_note" class="form-control"
                                                            id="changed_note_{{$tutor->id}}" rows="3"></textarea>
                                                    </div>
                                                    @php
                                                    $tutor_status_changed_notes =
                                                    \App\Models\TutorStatusNote::where('tutor_id', $tutor->id)->get();
                                                    @endphp
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button id="saveChanges_{{$tutor->id}}" type="button"
                                ...
                                <button class="btn btn-primary py-1" data-bs-toggle="modal"
                                    data-bs-target="#statusModal_{{$tutor->id}}">
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#deleteNoteModal_{{$tutor->id}}"><i
                                        class="fa fa-trash"></i></button>
                                @endif
                                <div class="modal fade" id="deleteNoteModal_{{$tutor->id}}" tabindex="-1"
                                    aria-labelledby="dateModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-xl">
                                        <div class="modal-content text-center">
                                            <form id="btndelete{{ $tutor->id }}"
                                                action="{{ route('tutor.destroy', ['tutor' => $tutor->id]) }}"
                                                method="POST" style="display:inline">
                                                @csrf
                                                @method('delete')
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        <label for="tutor_delete_note{{$tutor->id}}"
                                                            class="form-label">Enter your note here:</label>
                                                        <input required type="text" class="form-control"
                                                            id="tutor_delete_note{{$tutor->id}}"
                                                            name="tutor_delete_note"
                                                            placeholder="Enter your note here...">
                                                    </div>
                                                </div>
                                                <div class="modal-footer text-center">
                                                    <button type="button" class="btn btn-danger btn-lg"
                                                        id="{{ $tutor->id }}" onclick="tutorDeleteBtn(this.id)">Delete
                                                        Tutor</button>
                                                </div>
                                            </form>
                                            ...
                                            <div class="modal-body">
                                                @php
                                                $tutor_delete = \App\Models\TutorDeleteNote::where('tutor_id',
                                                $tutor->id)->get();
                                                @endphp
                                ...
                                <form style="font-size: 0" id="btnConfirmAlert{{ $tutor->id }}"
                                    ...
                                    <button class="btn btn-sm btn-primary" type="button" id="{{ $tutor->id }}"
                                        onclick="btnConfirmAlert(this, this.id)">
                                ...
                                <form style="font-size: 0" id="btnUndoAlert{{ $tutor->id }}"
                                    ...
                                    <button class="btn btn-sm btn-danger" type="button" id="{{ $tutor->id }}"
                                        onclick="btnUndoAlert(this, this.id)">
                                        <i class="fa fa-bell "></i>
                                    </button>
                                </form>
