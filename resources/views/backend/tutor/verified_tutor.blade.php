...
<main class="">
    <div class="col-md-9 ms-sm-auto col-lg-12" style="">
        ...
        <div class="d-flex gap-4 flex-column flex-md-row p-3 mb-2">
            ...
            <a class="text-decoration-none text-gray-800 active-border" href="{{route('admin.tutor.verified')}}">Verified Tutor</a>
        ...
        <div class="ps-3" style="padding-right: 13px">
            ...
            <div class="d-flex justify-content-between flex-column flex-lg-row gap-2 gap-lg-0">
                ...
                <div class="d-flex justify-content-between gap-3">
                    ...
                    @endif
                    <form action="{{ route('admin.verify.tutor.job') }}" method="post">
                        @csrf
                ...
                <div class="d-flex gap-3">
                    ...
                    <form id="paginationLimitForm" action="{{ route('admin.tutor.verified') }}" method="GET">
                ...
                <table id="example1" class="table table-responsive table-hover bg-white shadow-none"
                    ...
                    <thead class="text-dark" style="border-bottom: 1px solid #c8ced3">
                        <tr>
                            ...
                            <th scope="col" class="text-nowrap">Verify Info</th>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body pt-4 pb-4 px-5">
                                            ...
                                            <div class="row row-cols-2 border-bottom border-2 mb-4">
                                                <p class="fw-semibold">verify By</p>
                                                <p class="">{{$tutor->verifier->name ?? ''}}</p>
                                            </div>
                                            <div class="row row-cols-2">
                                                <p class="fw-semibold">verify Date</p>
                                                <p class="">{{$tutor->verify_date ?? ''}}</p>
                                            ...
                                            <div class="row row-cols-2">
                                                ...
                                                <p class="">{{ $tutor->premium_date ?? '' }}</p>  <!-- Display premium date -->
                                            </div>
