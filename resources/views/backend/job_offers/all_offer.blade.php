...
<main class="container-custom">
    ...
    <div class="d-flex gap-4 flex-column flex-md-row p-3 mb-2">
        ...
        <a class="text-decoration-none text-gray-800" href="{{ route('admin.job-count') }}">Counting</a>
    </div>
    ...
    <div class="ps-3" style="padding-right: 13px">
        ...
        <div class="d-flex gap-3">
            ...
            <form id="all_offer_paginationForm" action="{{ route('admin.job-offer.all-offers') }}" method="GET">
                <select id="all_offer_paginationLimit" name="pagination_limit" class="form-select rounded" style="width: 100px">
                ...
                <table class="table table-hover bg-white shadow-none" style="border-collapse: collapse">
                    ...
                    <tbody>
                        ...
                        <tr class="" style="vertical-align: middle; @if ($job->hire_date > now()) background-color:rgb(0, 0, 0,0.5);color:rgb(0, 0, 0);   @endif ">
                            ...
                            <td class="">{{ $job->course->name ?? 'N/A' }} <br>
                                            ...
                                            <div class="row row-cols-2 g-0">
                                                ...
                                                <div class="d-flex flex-column border-end">
                                                    ...
                                                    <div class="px-4 pt-4 pb-3">
                                                        ...
                                                        <p style="font-size: 16px">{{$job->taken_by_1_date}}</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-flex flex-column border-end">
                                                    ...
                                                    <div class="px-4 pt-4 pb-3">
                                                        ...
                                                        <p style="font-size: 16px">{{$job->taken_by_2_date}}</p>
                                                    </div>
                                                </div>
                            ...
                            <td class="text-center">
                                ...
                                {{-- <a class="text-primary rounded-pill text-decoration-none me-2" style="width: fit-content"
                          href="{{route('admin.job.applicant-list')}}">
                                6
                                </a>

                                <a class="bg-primary text-white rounded-pill text-decoration-none border border-primary"
                                    style="padding: 0px 5px 0px 5px" href="{{route('admin.job.applicant-list')}}">
                                    4
                                </a> --}}
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                {{-- <a class="btn btn-success btn-sm mb-1" href="{{ route('admin.job.see-condition') }}">See
                                Condition</a>

                                <a class="btn btn-info btn-sm mb-1" href="{{ route('admin.job.status-log') }}">
                                    Edit</a>

                                <a class="btn btn-info btn-sm mb-1" href="{{ route('admin.job.status-log') }}">Status
                                    Log</a>
                                <a class="btn btn-ndark btn-sm mb-1" onclick="searchTutor()" data-toggle="modal"
                                    data-target="#SearchTutorModal mb-1" data-dismiss="actionModal">Search
                                    Tutor</a>
                                <a class="btn btn-ndark btn-sm mb-1" href="{{ route('admin.job.sms-log') }}">SMS Log</a>
                                <a class="btn btn-danger btn-sm mb-1" href="{{ route('admin.job.status-log') }}">
                                    Delete</a> --}}
                    ...
                    <div
                        ...
                        <div class="d-flex gap-3">
                            ...
                            ">
                                ...
                                <p class="p-0 m-0">{{ old('latest_input_created', optional(@$smsLimit)->latest_input_created) }}</p>
                            </button>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="">
                                                    <div class="mb-3">
                                                        <label for="latest_created_input" class="form-label">Latest Created Tutor</label>
                                                        <input name="latest_created_input" type="number"
                                                            class="form-control rounded-3 shadow-none" id="latest_created_input"
                                                            placeholder="Enter number" style="padding: 14px 18px"
                                                            value="{{ old('latest_created_input', optional(@$smsLimit)->latest_created_input) }}">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="second_latest_created" class="form-label">2nd Latest Created</label>
                                                        <input name="second_latest_created" type="number"
                                                            class="form-control rounded-3 shadow-none" id="second_latest_created"
                                                            placeholder="Enter number" style="padding: 14px 18px"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="second_bottom" type="number"
                                                            class="form-control rounded-3 shadow-none" id="second_bottom"
                                                            placeholder="Enter number" style="padding: 14px 18px"
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="send_sms_range" class="form-label">Sms Send Range</label>
                                                        <input name="send_sms_range" type="number"
                                                            class="form-control rounded-3 shadow-none" id="send_sms_range"
                                                            placeholder="Enter number" style="padding: 14px 18px"
                    ...
                    <div class="mt-4">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="checkbox-wrapper-13">
                                ...
                                <input class="" type="checkbox" value="" checked id="selectAllTutor"
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <form action="{{ route('admin.job.tutor.sms') }}" target="_blank" method="post"
                                ...
                                <button class="btn btn-primary" id="sendSmsButton">Send SMS</button>
