                ...
                <tr style="border-bottom: 1px solid #dee2e6">
                    ...
                    <td>
                        <div class="fw-normal">
                            ...
                            <a href="{{ route('admin.job-details', $taken_job->jobOffer->id) }}">
                    ...
                    <td>
                        <div class="d-flex justify-content-start align-items-center gap-3">
                            ...
                            <div class="fw-semibold">
                                <a href="{{ route('admin.tutor.tutorshow', $taken_job->Tutor->id) }}">
                                    <p class="m-0 text-nowrap">
                        ...
                        <div class="btn-group" id="stageButton">
                            ...
                            <ul class="dropdown-menu dropdown-menu-lg-end border-0 p-0 m-0">
                                <div class="rounded-2 text-white-on-hover" style="border: 1px solid #d7dfe9">
                                    ...
                                    <li>
                                        <button onclick="stageJobId({{ $taken_job->id }},'waitingOffcanvas')"
                                    ...
                                    <li>
                                        <button type="button" class="dropdown-item" id="{{ $taken_job->id }}"
