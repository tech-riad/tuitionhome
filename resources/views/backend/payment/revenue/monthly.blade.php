            ...
            <div class="row gap-4 gap-md-0 ms-1 me-1 mb-4">
                <div class="col-12 col-md-6 col-lg-9">
                    <div class="bg-white shadow-lg rounded-3 p-4">
                        <p class="text-center fw-bold fs-5 mb-1">{{$servicePaymentSum + $smsRechargeSum}}</p>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="bg-white text-nowrap shadow-lg rounded-3 p-2 ps-5 ps-lg-4 ps-xl-5 mb-4 text-gray-800">
                        Amount :
                        <span class="ms-1">{{$servicePaymentSumMonthly ?? 0}}</span>
                    </div>
                    <div class="bg-white shadow-lg rounded-3 p-2 ps-5 ps-lg-4 ps-xl-5 text-gray-800">
                        Count : <span class="ms-3 ps-1">{{$servicePaymentSumMonthlyCount ?? 0}}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="ps-3 mt-4" style="padding-right: 13px">
                <div
                    ...
                    <div class="d-flex flex-wrap flex-md-nowrap gap-3">
                        <a href="{{route('admin.revenue.all')}}" class="btn btn-gdark">All</a>
                ...
                <div class="bg-white shadow-lg rounded-3 p-2 my-4">
                    <div class="bg-white pb-4 mb-b">
                                        ...
                                        <td class="">
                                            <div class="d-flex gap-2">
                                                ...
                                                @if ($item->is_verified == 0)
                                                    <button class="btn btn-warning py-1 service-verify-button" data-id="{{ $item->id }}">
                                                        Verify
                                                    </button>
                                                @else
                        ...
                        <div class="d-flex justify-content-center align-items-center gap-2 mt-3">
                            {{ $monthlyRevenue->appends(request()->query())->links() }}
