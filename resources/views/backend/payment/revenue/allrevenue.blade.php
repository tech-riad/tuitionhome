            ...
            <div class="ps-3 mt-4" style="padding-right: 13px">
                <div
                    ...
                    <div class="d-flex flex-wrap flex-md-nowrap gap-3">
                        <a href="{{route('admin.revenue.all')}}" class="btn {{ Request::is('admin/revenue/serch') ? 'btn-gdark' : '' }} {{ Request::is('admin/revenue/filter') ? 'btn-gdark' : '' }} {{ Request::is('admin/all-revenue') ? 'btn-gdark' : '' }}">All</a>
                                    ...
                                    <div class="flex-grow-1 pe-4">
                                        <div class="pb-3">
                                            ...
                                            <select name="user_i" class="form-select rounded-3 shadow-none select2"
                                                    aria-label="Default select"
                                                    onchange="inputChange('ownership_by',this.id)" id="user_i">
                                                    <option value="">Select Employee</option>
