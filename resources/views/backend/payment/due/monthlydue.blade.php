    ...
    <div class="col-md-12 col-lg-12" style="margin-top: 60px">
        ...
        <div class="row gap-4 gap-md-0 ms-1 me-1 mb-4">
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="bg-white text-nowrap shadow-lg rounded-3 p-2 ps-5 ps-lg-4 ps-xl-5 mb-4 text-gray-800">
                    Amount :
                    <span class="ms-1">{{$refundDueMonthly}}</span>
                </div>
                <div class="bg-white shadow-lg rounded-3 p-2 ps-5 ps-lg-4 ps-xl-5 text-gray-800">
                    Count : <span class="ms-3 ps-1">{{$refundDueMonthlyCount}}</span>
                </div>
            </div>
        </div>
        ...
        <div class="ps-3 mt-4" style="padding-right: 13px">
            <div class="d-flex flex-wrap flex-xl-nowrap justify-content-between flex-column flex-lg-row gap-2 gap-lg-0">
                ...
                <div class="d-flex flex-wrap flex-md-nowrap gap-3">
                    <a href="{{route('admin.due.payment')}}" class="btn btn-gdark">All</a>
                    <a href="{{route('admin.monthly.due')}}" class="btn btn-outline-gdark text-nowrap">
                        This Month
                    </a>
                    <button class="btn btn-outline-gdark text-nowrap" data-bs-toggle="modal"
                        data-bs-target="#showEditableDateTimeModal">
                        Set A Point
                    </button>
                    ...
                    </form>                    <select class="form-select rounded" style="width: 100px">
                        ...
                        <table class="table table-sm table-hover bg-white shadow-none"
                            ...
                            <tbody>
                                ...
                                <tr class="" style="vertical-align: middle">
                                    ...
                                    <td class="text-nowrap @if ($item->payment_status == 1) text-info @elseif ($item->payment_status == 0) text-warning

                                    @endif">@if ($item->payment_status == 1) Paid @elseif ($item->payment_status == 0) Pending
        ...
        <div class="modal fade" id="showEditableDateTimeModal" tabindex="-1"
            ...
            <div class="modal-dialog model-sm modal-dialog-centered" style="max-width: 400px">
                <div class="modal-content">
                    <div class="modal-body pt-5 pb-4">
                        <form action="{{route('admin.due.setpoint')}}">
