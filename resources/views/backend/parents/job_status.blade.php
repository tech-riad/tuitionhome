    ...
    <div class="col-md-12 ms-sm-auto col-lg-12 px-3" style="margin-top: 62px">
        ...
        <div class="d-flex gap-4 flex-wrap flex-column flex-md-row py-4 align-items-center">
            ...
            <a class="text-decoration-none text-gray-800 text-nowrap" href="{{route('admin.parent.posted.job',$id)}}">Posted
                Jobs</a>
            <a class="text-decoration-none text-gray-800 text-nowrap active-border" href="{{route('admin.parent.job.status',$id)}}">Status</a>
        ...
        <div>
            <!-- status section -->
            <div class="mb-4 row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5">
                <div>
                        ...
                        <div class="d-flex gap-3 justify-content-start align-items-center">
                            ...
                            <div class="pt-3">
                                <div class="d-flex justify-content-center align-itema-center flex-column">
                                    <p class="fs-4 fw-bold mb-0">{{$count['requestedJobsCount']}}</p>
                ...
                <div>
                    <div class="bg-white mb-4 mb-xl-0 rounded shadow-lg px-4 py-2">
                        <div class="d-flex gap-3 justify-content-start align-items-center">
                            <div class="text-white py-2 px-3 shadow-lg rounded" style="background-color: #86c240">
                            ...
                            <div class="pt-3">
                                <div class="d-flex justify-content-center align-itema-center flex-column">
                                    <p class="fs-4 fw-bold mb-0">{{$count['approvedJobCount']}}</p>
                                    <p class="text-gray-600 text-nowrap" style="font-size: 14px">
                                        Approved Jobs
                                    </p>
                                </div>
                ...
                <div>
                    <div class="bg-white mb-4 mb-xl-0 rounded shadow-lg px-4 py-2">
                        <div class="d-flex gap-3 justify-content-start align-items-center">
                            <div class="text-white py-2 px-3 shadow-lg rounded" style="background-color: #d885b4">
                                <i class="bi bi-archive-fill fs-4"></i>
                            </div>
                            <div class="pt-3">
                                <div class="d-flex justify-content-center align-itema-center flex-column">
                                    <p class="fs-4 fw-bold mb-0">{{$count['appointedJobsCount']}}</p>
                                    <p class="text-gray-600 text-nowrap" style="font-size: 14px">
                                        Appointed Jobs
                                    </p>
                                </div>
                ...
                <div>
                    <div class="bg-white mb-4 mb-xl-0 rounded shadow-lg px-4 py-2">
                        <div class="d-flex gap-3 justify-content-start align-items-center">
                            ...
                            <div class="pt-3">
                                <div class="d-flex justify-content-center align-itema-center flex-column">
                                    <p class="fs-4 fw-bold mb-0">{{$count['confirmJobsCount']}}</p>
                                    <p class="text-gray-600 text-nowrap" style="font-size: 14px">
                                        Confirmed Jobs
                                    </p>
                                </div>
                ...
                <div>
                    <div class="bg-white mb-4 mb-xl-0 rounded shadow-lg px-4 py-2">
                        <div class="d-flex gap-3 justify-content-start align-items-center">
                            <div class="text-white py-2 px-3 shadow-lg rounded" style="background-color: #f26969">
                                <i class="bi bi-x-circle-fill fs-4"></i>
                            </div>
                            <div class="pt-3">
                                <div class="d-flex justify-content-center align-itema-center flex-column">
                                    <p class="fs-4 fw-bold mb-0">{{$count['cancelJobsCount']}}</p>
                                    <p class="text-gray-600 text-nowrap" style="font-size: 14px">
                                        Cancelled Jobs
                                    </p>
                                </div>
            ...
            <div class="pb-4">
                        ...
                        <div class="bg-white p-4 shadow-lg rounded mb-1">
                            ...
                            <div class="d-flex border-top border-2 pt-3 justify-content-end">
                                    <a target="_blank" href="#"
                                        ...
                                        style="background-color: #e6eef7">{{$item->status}}</a>
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <div id="status_requestedJobs_navContainer"></div>
                </div>
            </div>
            <!-- requested jobs carousel section ends-->
            <!-- approved jobs carousel section starts-->
            <div class="pb-4">
                <p class="fs-3 fw-semibold mb-4">Approved Jobs</p>
                <!-- This class must be unique! -->
                <div class="owl-carousel live-on-owl-carousel">
                    @foreach ($approvedJobs as $item)
                    <div class="bg-white p-4 shadow-lg rounded mb-1">
                        <div class="d-flex justify-content-between align-items-start mb-5">
                            <h4 class="text-gray-800">{{$item->course->name}}</h4>
                            <div>
                ...
                <div class="d-flex justify-content-center">
                    <!-- This id must be unique, otherwise navigation won't show up! -->
                    <div id="status_approvedJobs_navContainer"></div>
                </div>
            </div>
            <!-- approved jobs carousel section ends-->
            <!-- appointed jobs carousel section starts-->
            <div class="pb-4">
                <p class="fs-3 fw-semibold mb-4">Appointed Jobs</p>
                <!-- This class must be unique! -->
                <div class="owl-carousel live-on-owl-carousel">
                    @foreach ($appointedJobs as $item)
                    <div class="bg-white p-4 shadow-lg rounded mb-1">
                        <div class="d-flex justify-content-between align-items-start mb-5">
                            <h4 class="text-gray-800">{{$item->course->name}}</h4>
                            <div>
                ...
                <div class="d-flex justify-content-center">
                    <!-- This id must be unique, otherwise navigation won't show up! -->
                    <div id="status_appointedJobs_navContainer"></div>
                </div>
            </div>
            <!-- appointed jobs carousel section ends-->
            <!-- confirmed jobs carousel section starts-->
            <div class="pb-4">
                <p class="fs-3 fw-semibold mb-4">Confirmed Jobs</p>
                <!-- This class must be unique! -->
                <div class="owl-carousel live-on-owl-carousel">
                    @foreach ($confirmJobs as $item)
                    <div class="bg-white p-4 shadow-lg rounded mb-1">
                        <div class="d-flex justify-content-between align-items-start mb-5">
                            <h4 class="text-gray-800">{{$item->course->name}}</h4>
                            <div>
                ...
                <div class="d-flex justify-content-center">
                    <!-- This id must be unique, otherwise navigation won't show up! -->
                    <div id="status_confirmedJobs_navContainer"></div>
                </div>
            </div>
            <!-- confirmed jobs carousel section ends-->
            <!-- cancelled jobs carousel section starts-->
            <div class="pb-4">
                <p class="fs-3 fw-semibold mb-4">Cancelled Jobs</p>
                <!-- This class must be unique! -->
                <div class="owl-carousel live-on-owl-carousel">
                    @foreach ($cancelJobs as $item)
                    <div class="bg-white p-4 shadow-lg rounded mb-1">
                        <div class="d-flex justify-content-between align-items-start mb-5">
                            <h4 class="text-gray-800">{{$item->course->name}}</h4>
                            <div>
                ...
                <div class="d-flex justify-content-center">
                    <!-- This id must be unique, otherwise navigation won't show up! -->
                    <div id="status_cancelledJobs_navContainer"></div>
                </div>
            </div>
            <!-- cancelled jobs carousel section ends-->
        </div>
        <!-- contents ends here -->
    </div>
</main>
