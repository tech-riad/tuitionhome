        ...
        <div class="container-custom">
            <div class="col-md-12 ms-sm-auto col-lg-12" style="margin-top: 62px">
                ...
                <div class="row gap-4 gap-md-0 ms-1 me-1 mb-4">
                    <div class="col-12">
                        <div class="bg-white shadow-lg rounded-3 p-4">
                            <p class="text-center fw-bold fs-5 mb-1">{{$totalLead + $totalfnfLead}}</p>
                ...
                <div class="row row-cols-1 gap-4 row-cols-md-2 row-cols-lg-4 gap-md-0 ms-1 me-1">
                    ...
                    <div class="mb-md-4 mb-lg-0">
                        <div class="bg-white shadow-lg rounded-3 p-4">
                            <p class="text-center fw-bold fs-5 mb-1">{{$totalfnfLead}}</p>
                ...
                <div class="ps-3 mt-4" style="padding-right: 13px">
                    <div
                        ...
                        <div class="d-flex flex-wrap flex-md-nowrap gap-3">
                            <form action="{{route('admin.parent.leads.search')}}" method="post">
                                @csrf
                                ...
                                <table class="table table-sm table-hover bg-white shadow-none"
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td class="text-nowrap"><a href="{{route('admin.parent.lead.view',$item->id)}}">{{$item->id}}</a></td>
                                            <td class="">{{$item->course->name ?? ''}}</td>
                                            <td class="">{{$item->tutor_gender}}</td>
                                            <td class="">
                                              <button data-bs-toggle="modal" data-bs-target="#locationModal_{{$item->id}}"
                                                style="border: none; background: none">
                                                <i class="bi bi-geo-alt-fill text-danger fs-5"></i>
                                              </button>
                                            </td>
                                            <!-- location model starts here-->
                                            <div class="modal fade" id="locationModal_{{$item->id}}" tabindex="-1" aria-labelledby="locationModalLabel_{{$item->id}}"
                                            aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body pb-2 pt-2">
                                                        ...
                                                        <div class="mt-2">
                                                            ...
                                                            <hr>
                                                            <p class="mb-0">{{$item->location->name ?? ''}} ,{{$item->city->name ?? ''}}, {{$item->country->name ?? ''}}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                              ...
                                              <div class="d-flex gap-2">
                                                <div class="dropdown">
                                                  ...
                                                  <ul class="dropdown-menu" style="border: 1px solid #d7dfe9">
                                                    <li>
                                                      <a class="dropdown-item" href="{{route('admin.parent.lead.job.post',$item->id)}}">Post Job</a>
                                                    </li>
                                                    ...
                                                    <li>
                                                      <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#adminNoteModal_{{$item->id}}"
                                                        href="#">Admin Note</a>
                                                    </li>
                                                  </ul>
                                                </div>
                                                        ...
                                                        <form id="cancelNoteForm_{{$item->id}}" method="POST">
                                                            ...
                                                            <div>
                                                                <label for="cancel_note" class="form-label text-dark">
                                                                    Please make a smart note about the cancel reasons to Parent
                                                                </label>
                                                ...
                                                <div class="modal-content p-2">
                                                    <div class="modal-body">
                                                        <form id="adminNoteForm_{{$item->id}}" method="POST">
                                                            @csrf
                                                            <div>
                                                                <label for="note" class="form-label text-dark">
                                                                    Please make a smart note about the cancel reasons to Admin
                                                                </label>
                                                                <textarea class="form-control shadow-none rounded-3"
                                                                          id="note"
                                                                          name="note"
                                                                          rows="5"
                                                                          placeholder="Maximum 200 characters can be given">{{$item->note ?? ''}}</textarea>
                                                            </div>
                                                        </form>
                                                    </div>
                                                    ...
                                                    <div class="modal-footer d-flex gap-2">
                                                        ...
                                                        <button type="button" class="btn btn-primary submit-admin-note"
                                                                data-id="{{$item->id}}">
                                                            Add Note
                                                        </button>
                                                    </div>
                                        ...
                                        <script>
                                            $(document).ready(function () {
                                                $(document).on("click", ".submit-cancel-note", function () {
                                                    ...
                                                    let actionUrl = `/admin/parent/leads/reject/job/${leadId}`;
                                        ...
                                        <script>
                                            $(document).ready(function () {
                                                $(document).on("click", ".submit-admin-note", function () {
                                                    ...
                                                    let actionUrl = `/admin/parent/leads/note/${leadId}`;
