    ...
    <div class="col-md-12 ms-sm-auto col-lg-12 px-3" style="margin-top: 62px">
        ...
        <div>
            ...
            <div class="table-responsive">
                <table class="table table-sm p-3 bg-white shadow-lg rounded-2">
                    <thead>
                        <tr>
                            <th scope="col">Date</th>
                            <th scope="col">Location</th>
                            <th scope="col" class="text-nowrap">Address details</th>
                            <th scope="col" class="text-nowrap">Add phone</th>
                            <th scope="col">Whatsapp</th>
                            <th scope="col" class="text-nowrap">Fb link</th>
                            <th scope="col">Gender</th>
                            <th scope="col">Pofession</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$item->whats_up_phone}}</td>
                            <td>{{$item->facebook_profile}}</td>
                            <td>{{$item->gender}}</td>
                            <td>{{$item->profession}}</td>
                            <td>{{$item->children_number}}</td>
                            <td>{{$item->class}}</td>
