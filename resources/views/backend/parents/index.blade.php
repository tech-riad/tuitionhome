...
<main class="container-custom">
    ...
    <div class="col-md-12 ms-sm-auto col-lg-12" style="margin-top: 62px">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <div class="d-flex gap-4 flex-column flex-md-row px-3 py-4">
                <a class="text-decoration-none text-gray-800 text-nowrap active-border"
                    href="{{route('parent.index')}}">Parents
                    Profile</a>
            </div>
        ...
        <div class="card-header">
            <a href="" class="btn btn-info btn-sm" data-toggle="modal" data-target="#parentImport"> <i
                    class="fas fa-plus-circle"></i> Import Parents</a>
        </div>

        @endif

        <div class="modal fade" id="parentImport" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Import Parent</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="{{ route('import.parent.data') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">

                            <div class="form-group">
                                <label for="country_flag">Parent Import CSV FIle</label>
                                <input type="file" class="form-control" name="file" required>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                            <button type="submit" class="btn btn-primary">Import Parent</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="ps-3 mt-4" style="padding-right: 13px">
            <div class="d-flex flex-wrap flex-xl-nowrap justify-content-between flex-column flex-lg-row gap-2 gap-lg-0">
                ...
                <div class="d-flex flex-wrap flex-md-nowrap gap-3">
                    ...
                    <form id="paginationLimitForm" action="{{ route('parent.index') }}" method="GET">
                        ...
                        <table class="table table-sm table-hover bg-white shadow-none"
                            ...
                            <thead class="text-dark" style="border-bottom: 1px solid #c8ced3">
                                <tr>
                                    ...
                                    <th scope="col" class="text-nowrap">Alert</th>
                            ...
                            <tbody>
                                ...
                                <tr class="align-middle">
                                    <td scope="row" class="text-center text-nowrap" style="padding: 30px 18px">
                                        <input class="checkboxx" type="checkbox" name="ids" id="{{ $parentt->id }}"
                                            value="{{ $parentt->id }}" />
                                        <a class="text-decoration-none text-gray-700 btn" id="{{$parentt->created_at}}"
                                            onclick="dateTime(this.id)" data-bs-toggle="modal"
                                            data-time="{{ $parentt->created_at->diffForHumans() }}"
                                    ...
                                    <td class="text-info">
                                        <a href="{{route('admin.view.parent',$parentt->id)}}"
                                            class="text-decoration-none text-info">{{$parentt->unique_id}}</a>
                                    ...
                                    <td>{{$parentt->phone}}</td>
                                    <td class="text-nowrap">{{$parentt->ParentPersonalInfo->address_details ?? 'n/a'}}
                                    </td>
                                    <td>{{$parentt->ParentPersonalInfo->gender ?? 'n/a'}}</td>
                                    <td class="text-nowrap">Web</td>
                                    <td scope="col" class="text-nowrap">
                                        <!-- Status Modal -->
                                        <div class="modal fade" id="statusModal_{{$parentt->id}}" tabindex="-1"
                                            aria-labelledby="statusModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="statusModalLabel">Change Tutor
                                                            Status</h5>
                                                        ...
                                                        <form id="statusForm_{{$parentt->id}}">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="status" class="form-select"
                                                                    ...
                                                                    <option value="1" @if ($parentt->is_active == 1)
                                                                        selected @endif>Active</option>
                                                                    <option value="0" @if ($parentt->is_active == 0)
                                                                        selected @endif>Inactive</option>
                                                                </select>
                                                            </div>
                                                            <!-- Reason for Status Change -->
                                                            <div class="mb-3">
                                                                <label for="changed_note" class="form-label">Reason for
                                                                    Status Change</label>
                                                                <textarea name="changed_note" class="form-control"
                                                                    id="changed_note_{{$parentt->id}}"
                                                                    rows="3"></textarea>
                                                            </div>

                                                            <!-- Fetch and Display Status Change Notes -->
                                                            @php
                                                            $tutor_status_changed_notes =
                                                            \App\Models\ParentDeactivateNote::where('parent_id',
                                                            $parentt->id)->orderBy('id','desc')->get();
                                                            @endphp
                                                            ...
                                                            <table class="table table-responsive-sm">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th scope="col" style="min-width: 60px;">Reason
                                                                        </th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td>{{ \Carbon\Carbon::parse($note->created_at)->format('d-m-Y H:i:s') }}
                                                                        </td>
                                                                        <td>{{ $note->note }}</td>
                                                                        <td>
                                                                            @if ($note->action == 1)
                                                                            <a href="#"
                                                                                class="btn btn-primary py-1">Active</a>
                                                                            @elseif ($note->action == 0)
                                                                            <a href="#"
                                                                                class="btn btn-danger py-1">Inactive</a>
                                                                            @endif
                                                                        </td>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button id="saveChanges_{{$parentt->id}}" type="button"
                                        ...
                                        <button
                                            class="btn @php echo $parentt->is_active == 1 ? 'btn-primary' : 'btn-danger'; @endphp py-1"
                                        ...
                                        <script>
                                            $(document).ready(function () {
                                                ...
                                                $('#saveChanges_{{$parentt->id}}').on('click', function () {
                                                    var formData = $('#statusForm_{{$parentt->id}}')
                                                        .serialize();
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        error: function (xhr, status, error) {
                                                            ...
                                                            alert(
                                                                'Error updating tutor status. Please try again.'
                                                                );
                                                        }
                                                    });
                                                });
                                    ...
                                    <td>
                                        <div class="switch-toggle">
                                            <div class="button-check" id="button-check" data-id="{{$parentt->id}}"
                                                ...
                                                <input type="checkbox" class="checkbox" @if($parentt->is_sms == 1)
                                                checked @endif
                                                />
                                    ...
                                    <div class="modal fade" id="viewModal_{{$parentt->id}}" tabindex="-1"
                                        aria-labelledby="idInfoModalLabel_{{$parentt->id}}" aria-hidden="true">
                                    ...
                                    <td>
                                        @if ($parentt->is_alerted == 1)

                                        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#alertModalUndo_{{$parentt->id}}"><i
                                                class="fa fa-bell"></i></button>


                                        <div class="modal fade" id="alertModalUndo_{{$parentt->id}}" tabindex="-1"
                                            aria-labelledby="dateModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content text-center">
                                                    <form id="btnalertundo{{ $parentt->id }}"
                                                        action="{{ route('parent.undo.alert', ['parent' => $parentt->id]) }}"
                                                        method="POST" style="display:inline">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                <label for="changed_noteUndo_{{$parentt->id}}"
                                                                    class="form-label">Alert Undo Note Enter:</label>
                                                                <input required type="text" class="form-control"
                                                                    id="changed_noteUndo_{{$parentt->id}}"
                                                                    name="changed_note"
                                        ...
                                        <script>
                                            document.addEventListener('DOMContentLoaded', function () {
                                                ...
                                                document.getElementById('btnalertundo{{ $parent->id }}')
                                        ...
                                        @elseif($parentt->is_alerted == 0)
                                        <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#alertModal_{{$parentt->id}}"><i
                                                class="fa fa-bell"></i></button>

                                        <div class="modal fade" id="alertModal_{{$parentt->id}}" tabindex="-1"
                                            aria-labelledby="dateModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content text-center">
                                                    <form id="btnalert{{ $parentt->id }}"
                                                        action="{{ route('parent.make.alert', ['parent' => $parentt->id]) }}"
                                                        method="POST" style="display:inline">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                <label for="changed_note_{{$parentt->id}}"
                                                    ...
                                                    <div class="modal-body">
                                                        @php
                                                        $parent_alert = \App\Models\ParentAlertNote::where('parent_id',
                                                        $parentt->id)->get();
                                                        @endphp
                                                        @if ($parent_alert->isNotEmpty())
                                                        ...
                                                        <table class="table table-responsive-sm">
                                                            ...
                                                            <tbody>
                                                                @foreach ($parent_alert as $alert_note)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <button type="button"
                                                                            class="btn btn-success btn-sm">Undo</button>

                                                                        @elseif($alert_note->status == 1)
                                                                        <button type="button"
                                                                            class="btn btn-danger btn-sm">Alerted</button>
                                        ...
                                        <script>
                                            document.addEventListener('DOMContentLoaded', function () {
                                                @foreach($parents as $parent)
                                                document.getElementById('btnalert{{ $parent->id }}')
                                                    .addEventListener('submit', function (event) {
                                                        event.preventDefault();
                                                        var form = this;
                                    ...
                                    <td>
                                        <button type="button" class="btn  @if($parentt->parent_manage_note == null) btn-secondary

                                        @else
                                            btn-danger
                                        @endif " data-bs-toggle="modal"
                                            data-bs-target="#additional_note_{{$parentt->id}}">
                                            Note
                                        </button>

                                        <div class="modal fade" id="additional_note_{{$parentt->id}}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form id="additional-note-form-{{$parentt->id}}">
                                                        @csrf
                                                        <input type="hidden" name="parent_id" value="{{$parentt->id}}">
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                <label for="note" class="form-label">Note</label>
                                                                <textarea name="parent_manage_note"
                                                                    class="form-control rounded-3 shadow-none"
                                                                    id="parent_manage_note_{{$parentt->id}}"
                                                                    style="padding: 14px 18px">{{$parentt->parent_manage_note}}</textarea>
                                                                <span
                                                                    class="text-danger error-text parent_manage_note_error"></span>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary"
                                                ...
                                                <ul class="dropdown-menu" style="border: 1px solid #d7dfe9">
                                                    <li>
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.make.super.parent', $parentt->id) }}">Super
                                                            Parents</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.make.unplesant.parent', $parentt->id) }}">Unpleasant
                                                            Parents</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.verify.parent', $parentt->id) }}">Verify
                                                            Parents</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" data-bs-toggle="modal"
                                                            data-bs-target="#alertModal" href="#">Alert</a>
                                                    </li>
                                                    <!--<li>-->
                                                    <!--    <a class="dropdown-item" data-bs-toggle="modal"-->
                                                    <!--        data-bs-target="#noteModal_{{$parentt->id}}"-->
                                                    <!--        href="#">Note</a>-->
                                                    <!--</li>-->
                                                    <li>
                                                        <a class="dropdown-item" data-bs-toggle="modal"
                                                            data-bs-target="#createNoteModal_{{$parentt->id}}"
                                ...
                                <!-- Note Modal -->
                                <div class="modal fade" id="noteModal_{{$parentt->id}}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div id="noteContent_{{$parentt->id}}"
                                ...
                                <script>
                                    $(document).ready(function () {
                                        $('[data-bs-target="#noteModal_{{$parentt->id}}"]').on('click',
                                            function () {
                                                var parentId = {
                                                    {
                                                        $parentt - > id
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (response) {
                                                        if (response.success) {
                                                            $('#noteContent_' + parentId)
                                                            .empty();

                                                            response.notes.forEach(function (
                                                                note) {
                                                                var noteHtml = `
                                                            ...
                                                            $('#noteContent_' + parentId).html(
                                                                '<p>No notes available for this parent.</p>'
                                                                );
                                                        }
                                                    },
                                                    error: function (xhr, status, error) {
                                                        console.error(xhr.responseText);
                                                        $('#noteContent_' + parentId).html(
                                                            '<p>Error fetching the notes. Please try again later.</p>'
                                                            );
                                                    }
                                                });
                                            });
                                ...
                                <div class="modal fade" id="createNoteModal_{{$parentt->id}}" tabindex="-1"
                                        ...
                                        <div class="modal-content p-3">
                                            ...
                                            <div class="modal-body">
                                                <form id="createNoteForm_{{$parentt->id}}">
                                                    <div class="mb-3">
                                                        <label for="noteTitle_{{$parentt->id}}"
                                                            class="form-label text-dark">Note Title</label>
                                                        <input type="text" class="form-control shadow-none rounded-3"
                                                            id="noteTitle_{{$parentt->id}}" name="note_title"
                                                            placeholder="Maximum 8 words can be given" />
                                                    </div>
                                                    <div>
                                                        <label for="noteDetails_{{$parentt->id}}"
                                                            class="form-label text-dark">Note Details</label>
                                                        <textarea class="form-control shadow-none rounded-3"
                                                            id="noteDetails_{{$parentt->id}}" name="note_details"
                                                            rows="3"
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary"
                                                    id="saveNote_{{$parentt->id}}">Save</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    $(document).ready(function () {
                                        $('#saveNote_{{$parentt->id}}').on('click', function () {
                                            ...
                                            var formData = {
                                                ...
                                                note_details: $('#noteDetails_{{$parentt->id}}')
                                                    .val(),
                                                _token: '{{ csrf_token() }}'
                                            };
        ...
        <form action="{{route('admin.parent.filter')}}" method="post">
            @csrf
                        ...
                        <div class="modal-body py-0" style="padding-left: 40px">
                            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 pe-4">
                                        ...
                                        <div class="pb-3">
                                            ...
                                            <select name="gender" id="gender" class="shadow rounded-3 form-select"
                                                aria-label="Default select example">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1 pe-4">
                                        <div class="pb-3">
                                            <label for="utype" class="form-label">Parent Type</label>
                                            <select name="parent_type" class="form-select rounded-3 shadow-none select2"
                                                aria-label="Default select " id="parent_type">
                                                ...
                                                <option value="is_unplesant">Unplesant</option>
                                                <option value="is_super">Super</option>
                                            </select>

                                        </div>

                                        <div class="pb-3">
                                            <label for="kids" class="form-label text-dark text-sm">Number Of
                                                Kids</label>
                                            <input type="number" class="form-control shadow rounded-2"
                                                placeholder="Enter Number of Kida " name="kids" id="kids">

                                        </div>
                                        <div class="pb-3">
                                            <label for="Other" class="form-label text-dark text-sm">Profession</label>
                        ...
                        <div class="modal-body pt-0">
                            ...
                            <div class="row row-cols-md-2">
                                <div class="mb-3">
                                    ...
                                    <input id="name" name="name" class="shadow-none rounded-3 form-control"
                                        placeholder="Enter your name" />
                                </div>
                                <div class="mb-3">
                                    <label for="phone" class="form-label text-dark text-sm required">Phone</label>
                                    <input id="phone" name="phone" class="shadow-none rounded-3 form-control"
                                        placeholder="Enter your phone" />
                                </div>
                                <div class="mb-3">
                                    <label for="email" class="form-label text-dark text-sm">Email</label>
                                    <input id="email" name="email" class="shadow-none rounded-3 form-control"
                                ...
                                <div class="mb-3 mb-md-0">
                                    ...
                                    <input id="Password" name="password"
                                        ...
                                        placeholder="12345678 / By Default" disabled />
                                </div>
                                <div class="mb-3 mb-md-0">
                                    <label for="pass" class="form-label text-dark text-sm required">Re-Password</label>
                                    <input id="rePassword" class="shadow-none rounded-3 form-control bg-light"
                                        placeholder="12345678 / By Default" disabled />
                                </div>
                            </div>
                        </div>
